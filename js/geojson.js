...
var route = {
  ...
  var counter = 0;
    map.on('load', function () {
        ...
        if (point.features[0].geometry.coordinates[300] == test[0] && point.features[1].geometry.coordinates[301] == test[1]){
          console.log("test");
          
          // *find how to insert newline
          var popup = new mapboxgl.Popup({ offset: 0 })
            .setText("Base Camp-                                                             Elevation: 17,600 ft (5,380 m); Oxygen Content: 11%; Distance to Summit: 11,435 ft (3,485 m)");
